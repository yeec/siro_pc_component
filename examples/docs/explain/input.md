...
:::demo
```html
<com-input v-model="input" placeholder="请输入内容"></com-input>
...
```html
<com-input placeholder="请输入密码" v-model="input" show-password></com-input>
...
<div class="demo-input-suffix">
  ...
  <com-input
    placeholder="请选择日期"
    v-model="input3">
    <i slot="suffix" class="com-input__icon el-icon-date"></i>
  </com-input>
  <com-input
    placeholder="请输入内容"
    v-model="input4">
    <i slot="prefix" class="com-input__icon el-icon-search"></i>
  </com-input>
</div>
...
```html
<div>
  <com-input placeholder="请输入内容" v-model="input1">
    <template slot="prepend">Http://</template>
  </com-input>
</div>
<div style="margin-top: 15px;">
  <com-input placeholder="请输入内容" v-model="input2">
    <template slot="append">.com</template>
  </com-input>
</div>
<div style="margin-top: 15px;">
  <com-input placeholder="请输入内容" v-model="input3" class="input-with-select">
...
<style>
  .com-select .com-input {
    width: 130px;
  }
  .input-with-select .com-input-group__prepend {
...
<el-autocomplete
  ...
  @select="handleSelect">
  <i
    class="el-icon-edit com-input__icon"
    slot="suffix"
