  ...
  export default {
    ...
    render(h) {
      ...
      let triggerElm = !splitButton
        ? this.$slots.default
        : (<com-button-group>
          <com-button type={type} size={dropdownSize} nativeOn-click={handleMainButtonClick}>
            {this.$slots.default}
          </com-button>
          <com-button ref="trigger" type={type} size={dropdownSize} class="el-dropdown__caret-button">
